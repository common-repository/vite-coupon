...
if ( ! class_exists( __NAMESPACE__ . '\Vite_Coupon_Loader' ) ) {
	/**
	 * Class Vitepos_Loader
	 *
	 * @package VitePos\Libs
	 */
	class Vite_Coupon_Loader extends WP_Loader {
		...
		public function set_details() {
			$this->plugin_file     = 'vite-coupon/vite-coupon.php';
			$this->pro_plugin_file = 'vite-coupon-pro/vite-coupon-pro.php';
		}
