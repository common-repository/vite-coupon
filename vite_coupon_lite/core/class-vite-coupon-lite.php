 ...
 *
 * @package Vite_Coupon_Lite\Core
 */

namespace Vite_Coupon_Lite\Core;

use Appsbd_Lite\V2\Core\Kernel_Lite;
use Vite_Coupon_Lite\Libs\App_Language;
 ...
 * @package Vite_Coupon_Lite\Core
 */
class Vite_Coupon_Lite extends Kernel_Lite {
	/**
	...
	public function initialize() {
		$this->plugin_base = 'vite-coupon';
		$this->menu_icon  = 'dashicons-vco-logo';
		$this->menu_label = 'Vite Coupon';
	}
	...
	public function register_modules() {
		$this->add_module( 'Vite_Coupon_Lite\Modules\Vite_Coupon_Plugin' );
		$this->add_module( 'Vite_Coupon_Lite\Modules\Vite_Coupon_Category' );
		$this->add_module( 'Vite_Coupon_Lite\Modules\Vite_Coupon_Settings' );
	}
	...
	public function on_admin_global_styles_lite() {
		 $this->add_style( 'apbd-vc-fonts', 'admin-assets/font.css', true );
	}
	...
	public function on_admin_scripts_lite() {
		...
		$this->add_script( 'vite-coupon-admin' );
		...
		$jv_object->assets_path                                = Vite_Coupon_Plugin::get_module_instance()->get_plugin_url( 'admin-assets/' );
		$jv_object->ajax_nonce                                 = wp_create_nonce( 'coupon-settings' );
		...
		$jv_object->format                                     = array( 0, 2, 5 );
		/**
		 * Its for check is there any change before process
		 *
		 * @since 1.0
		 */
		$jv_object = apply_filters( 'appsbd/nvcad/settings', $jv_object );
		wp_localize_script( 'vite-coupon-admin', 'apbd_coupon', (array) $jv_object );
	}
	...
	public function on_admin_styles_lite() {
		 $this->add_style( 'vite-coupon-admin', 'admin-assets/css/style.min.css', true );
	}
	/**
